    ...
    <section>
        ...
        <section class="grid sm:grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-white p-6">
                <h2 class="text-2xl font-semibold mb-1">Soutenances à venir</h3>
                <p class="text-sm text-gray-500">Prochaines soutenances programmées</p>
                <div class="mt-4">
                    <div class="border border-gray-300 rounded-lg py-2 px-3 mb-4">
                        <h5 class="flex justify-between"><span>John Doe</span><span>28 Juin</span></h5>
                        <p class="flex justify-between text-sm text-gray-500"><span>Badass le beau</span><span>14h00</span></p>
                    </div>
                    <div class="border border-gray-300 rounded-lg py-2 px-3 mb-4">
                        <h5 class="flex justify-between"><span>Badass</span><span>01 Septembre</span></h5>
                        <p class="flex justify-between text-sm text-gray-500"><span>Badass le beau</span><span>08h00</span></p>
                    </div>
                    <div class="border border-gray-300 rounded-lg py-2 px-3 mb-4">
                        <h5 class="flex justify-between"><span>John Doe</span><span>01 Janvier</span></h5>
                        <p class="flex justify-between text-sm text-gray-500"><span>Badass le beau</span><span>14h30</span></p>
                    </div>
                </div>
            </div>
        </section>
