                    ...
                    <div class="bg-white px-4 pt-7 pb-2 rounded-xl border border-gray-300">
                        <div class="flex justify-between items-center">
                            ...
                            <div class="voirButton p-1 hover:bg-gray-300 rounded cursor-pointer relative">
                                ...
                                <div class="optionsPopup bg-white border border-gray-300 p-2 w-[130px] rounded absolute top-[100%] left-5 hidden">
                                    <ul class="flex flex-col gap-2">
                                        <li>
                                            <a class="flex gap-3 items-center hover:bg-gray-200 p-1 rounded" href="{{ route('admin.professeurs.show', $professeur) }}">
                                        ...
                                        <li>
                                            <a class="flex gap-3 items-center hover:bg-gray-200 p-1 rounded" href="{{ route('admin.professeurs.edit', $professeur) }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
                                        ...
                                        <li>
                                            <form action="{{ route('admin.professeurs.destroy', $professeur) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                        ...
                        <div class="flex justify-between py-4">
                            <p class="text-sm"><span class="font-medium">{{ $professeur->nbr_docs }}</span> document(s)</p>
                        ...
                        <tbody>
                            @foreach ($professeurs as $professeur)
                                <tr class="border-t-1 border-gray-300">
                                    ...
                                    <td>
                                        <p></p>
                                        <p>{{ $professeur->prof_created_at }}</p>
                                    </td>
                                    <td class="flex flex-col items-center">
                                        <span>{{ $professeur->nbr_docs }}</span><span>document(s)</span>
                                    </td>
                                    <td>
                                        <div class="voirButton w-fit p-1 hover:bg-gray-300 rounded cursor-pointer relative">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 12.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5ZM12 18.75a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5Z" />
                                            </svg>
                                            <div class="optionsPopup bg-white border border-gray-300 p-2 w-[130px] rounded absolute top-[100%] left-0 hidden">
                                                <ul class="flex flex-col gap-2">
                                                    <li>
                                                        <a class="flex gap-3 items-center hover:bg-gray-200 p-1 rounded" href="{{ route('admin.professeurs.show', $professeur) }}">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4">
