...
@section('content')
    <script src="{{ asset('assets/scripts/professeur.js') }}" defer></script>
    <section>
        @if($errors->any())
            <ul>
            ...
            <div class="grid grid-cols-3 gap-3">
                @foreach($professeurs as $professeur)
                    <div class="bg-white px-6 py-7 rounded-xl border border-gray-300">
                        ...
                        <a class="border flex justify-center gap-3 rounded-sm py-1 border-gray-400 hover:bg-gray-50" href="">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
