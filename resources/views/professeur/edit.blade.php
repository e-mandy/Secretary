    ...
    <section>
        ...
        <form action="">
            <section class="bg-white p-6 rounded-lg shadow mb-10">
                ...
                <div class="grid grid-cols-2 gap-8">
                    <label class="flex flex-col gap-1" for="lastname">
                        Nom
                        <input class="outline-none border border-gray-200 py-[6px] px-3 w-full rounded" type="text"id="lastname">
                    </label>
                    <label class="flex flex-col gap-1" for="firstname">
                        Prénom
                        <input class="outline-none border border-gray-200 py-[6px] px-3 w-full rounded" type="text" id="firstname">
                    </label>
                    <label class="flex flex-col gap-1" for="email">
                        Email
                        <input class="outline-none border border-gray-200 py-[6px] px-3 w-full rounded" type="email" id="email">
                    </label>
                    <label class="flex flex-col gap-1" for="phone">
                        Téléphone
                        <input class="outline-none border border-gray-200 py-[6px] px-3 w-full rounded" type="text" id="phone">
                    </label>
                </div>
            </section>
            ...
            <section class="bg-white p-6 rounded-lg shadow mb-10">
                ...
                <div>
                    <label class="flex flex-col gap-1 w-1/2" for="lastname">
                        Spécialité
                        <input class="outline-none border border-gray-200 py-[6px] px-3 w-full rounded" type="text"id="lastname">
                    </label>
                </div>
            ...
            <div class="flex gap-4 justify-end">
                <button class="add_prof flex items-center bg-white border border-gray-300 text-black rounded-lg px-3 py-2 gap-4 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
