    ...
    <section>
        ...
        <section class="grid grid-cols-4 gap-6 mb-8">
            <div class="bg-blue-200 p-4 rounded-lg shadow opacity-75">
                ...
                <span class="text-3xl text-blue-700">19</span>
            </div>
            <div class="bg-green-200 p-4 rounded-lg shadow opacity-75">
                ...
                <span class="text-3xl text-green-700">9</span>
            </div>
        </section>
        <section class="bg-white px-6 pt-6">
            <div class="flex justify-between items-center mb-5">
                <div>
                    ...
                    <p class="text-[#71717A]">0 document(s) trouvé(s)</p>
                </div>
                <div>
            ...
            <div class="grid grid-cols-4 pb-8">
                <div class="bg-white px-6 py-5 rounded-lg border border-gray-300">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="text-lg font-medium mb-1">Jean_Martin.pdf</h4>
                                <span class="block w-fit py-1 px-4 bg-blue-300 rounded-xl text-blue-700 text-xs hover:bg-gray-800 text-center">CV</span>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-between py-4 items-center">
                        <p class="bg-green-200 px-5 text-center text-green-800 py-1 rounded-2xl text-sm font-bold">Validé</p>
